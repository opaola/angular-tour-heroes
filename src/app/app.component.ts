...
export class AppComponent {
  name = 'Paola'; /* en el componente angular original se cambia titulo por la variable creada en 'ejemploangular.ts'. y siempre deben ir publico para que coja en el html*/
  age = 18;
  img = '/assets/imagen/_a291cbef-3687-4db6-ad9c-1ac05833e437.jpg';
